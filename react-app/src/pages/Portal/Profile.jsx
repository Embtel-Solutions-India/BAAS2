...
export default function Profile() {
  ...
  const handleProfileSubmit = async (e) => {
    ...
    try {
      ...
      // Let the portal layout (sidebar/header) refresh its cached user too.
      ...
      <div className="w-full grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          ...
          <div className="bg-white rounded-xl border border-gray-100 p-6 md:p-8 shadow-sm">
            ...
            <p className="text-xs text-gray-400 mb-5 leading-relaxed">Update your name and contact details.</p>
        ...
        {/* Right column: identity summary + account info */}
        <div className="flex flex-col gap-6">
          <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm flex flex-col items-center text-center">
            <div className="w-20 h-20 rounded-full bg-gradient-to-tr from-[#d4001f] to-[#a4001a] text-white flex items-center justify-center font-serif text-3xl font-bold shadow-xs shrink-0">
              {avatarLetters || '?'}
            </div>
            <h2 className="text-lg font-bold text-gray-900 leading-tight mt-4">{user?.first_name} {user?.last_name}</h2>
